							...
							<a href="/teknis/unit/detail-unit/{data.informasi_unit.id_unit}" class="no-decor">
								<div class="card-head w-content-2 height-fit">
									<div class="flex">
										...
										{#if data.progress_teknis.length == 0}
										<div class="flex flex-direction-col flex-center-vertical flex-center-horizontal w-100">
											<div class="flex w-100 flex-center-horizontal">
										...
										<div class="flex flex-direction-col flex-center-vertical flex-center-horizontal w-50">
											<div class="flex w-100 flex-center-horizontal">
												<div class="flex flex-center-horizontal w-60 flex-gap-semi-large">
													...
													<div class="text-drop-card padding-spec-nup-1"><input type="radio" name=""> <label>Makadam</label></div>
												</div>
												<div class="flex flex-center-horizontal w-40">
													<div class="text-drop-card padding-spec-nup-1 "><input type="checkbox" name=""></div>
												</div>
										...
										<div class="flex flex-direction-col flex-center-vertical flex-center-horizontal w-100">
											<div class="flex w-100 flex-center-horizontal">
												<div class="flex flex-center-horizontal w-20">
													{#if data.progress_teknis[0].detail[0].progress == true}
												...
												<div class="flex flex-center-horizontal w-20">
													{#if data.progress_teknis[0].detail[1].progress == true}
														<div class="text-drop-card padding-spec-nup-1 "><input type="checkbox" name="" checked></div>
													{:else}
														<div class="text-drop-card padding-spec-nup-1 "><input type="checkbox" name=""></div>
													{/if}
												...
												<div class="flex flex-center-horizontal w-20">
													{#if data.progress_teknis[0].detail[2].progress == true}
														<div class="text-drop-card padding-spec-nup-1 "><input type="checkbox" name="" checked></div>
													{:else}
														<div class="text-drop-card padding-spec-nup-1 "><input type="checkbox" name=""></div>
													{/if}
												...
												<div class="flex flex-center-horizontal w-40">
													{#if data.progress_teknis[0].detail[3].progress == true}
														<div class="text-drop-card padding-spec-nup-1 "><input type="checkbox" name="" checked></div>
													{:else}
														<div class="text-drop-card padding-spec-nup-1 "><input type="checkbox" name=""></div>
													{/if}
										...
										<div class="flex flex-direction-col flex-center-vertical flex-center-horizontal w-50">
											<div class="flex w-100 flex-center-horizontal">
												<div class="flex flex-center-horizontal w-60 flex-gap-semi-large">
													{#if data.progress_teknis[1].detail[0].progress == true && data.progress_teknis[1].detail[0].nama_progress == "Jalan Cor"}
														<div class="text-drop-card padding-spec-nup-1"><input type="radio" name="" checked> <label>Cor</label></div>
													{:else if data.progress_teknis[1].detail[0].progress == false && data.progress_teknis[1].detail[0].nama_progress == "Jalan Cor"}
														<div class="text-drop-card padding-spec-nup-1"><input type="radio" name=""> <label>Cor</label></div>
													{:else }
													<div class="text-drop-card padding-spec-nup-1"><input type="radio" name=""> <label>Cor</label></div>
													{/if}
													{#if data.progress_teknis[1].detail[0].progress == true && data.progress_teknis[1].detail[0].nama_progress == "Jalan Makadam"}
														<div class="text-drop-card padding-spec-nup-1"><input type="radio" name="" checked> <label>Makadam</label></div>
													{:else if data.progress_teknis[1].detail[0].progress == false && data.progress_teknis[1].detail[0].nama_progress == "Jalan Makadam"}
														<div class="text-drop-card padding-spec-nup-1"><input type="radio" name=""> <label>Makadam</label></div>
													{:else }
													<div class="text-drop-card padding-spec-nup-1"><input type="radio" name=""> <label>Makadam</label></div>
													{/if}
												...
												<div class="flex flex-center-horizontal w-40">
													{#if data.progress_teknis[1].detail[1].progress == true}
														<div class="text-drop-card padding-spec-nup-1 "><input type="checkbox" name="" checked></div>
													{:else}
														<div class="text-drop-card padding-spec-nup-1 "><input type="checkbox" name=""></div>
													{/if}
										...
										<div class="flex flex-direction-col flex-center-vertical flex-center-horizontal w-70">
											<div class="flex w-100 flex-center-horizontal">
												<div class="flex flex-center-horizontal w-50">
													{#if data.progress_teknis[2].detail[0].progress == true}
														<div class="text-drop-card padding-spec-nup-1 "><input type="checkbox" name="" checked></div>
													{:else}
														<div class="text-drop-card padding-spec-nup-1 "><input type="checkbox" name=""></div>
													{/if}
												...
												<div class="flex flex-center-horizontal w-50">
													{#if data.progress_teknis[2].detail[1].progress == true}
														<div class="text-drop-card padding-spec-nup-1 "><input type="checkbox" name="" checked></div>
													{:else}
														<div class="text-drop-card padding-spec-nup-1 "><input type="checkbox" name=""></div>
													{/if}
