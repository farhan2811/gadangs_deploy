<script type="text/javascript">
	...
	let getDetailData = () => {
		ApiController({
			method: 'GET',
			endpoint: `teknis/unit/${data.params.slug}`
		}).then(response => {
			...
			<div class="flex flex-direction-col flex-gap-large" in:fly={{ y: -20, duration: 600 }}>
				...
				<div class="flex flex-direction-col flex-gap-large w-100">
					...
					{#if completeData}
						...
						{#if completeData.data_pembangunan == null}
											...
											<div class="w-100 flex flex-direction-col flex-gap-semi-small">
												...
												<div class="flex w-100">
													<div class="flex flex-direction-col w-100">
														<div class="caption-card-detail">Keterangan</div>
														<div class="caption-card-detail">-</div>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="w-100 flex flex-direction-col flex-gap-regular">
											<div class="w-100 flex flex-direction-col flex-gap-semi-small">
												...
												<div class="flex w-100">
													<div class="flex flex-direction-col w-50">
														<div class="caption-card-detail">Mulai Pembangunan</div>
														<div class="content-card-detail">{completeData.data_pembangunan.tanggal_mulai}</div>
													</div>
													<div class="flex flex-direction-col w-50">
														<div class="caption-card-detail">Target Selesai</div>
														<div class="content-card-detail">{completeData.data_pembangunan.tanggal_target}</div>
													</div>
												</div>
												<div class="flex w-100">
													<div class="flex flex-direction-col w-50">
														<div class="caption-card-detail">Sisa Waktu</div>
														<div class="content-card-detail">{(moment(completeData.data_pembangunan.tanggal_target, "DD/MM/YYYY").toDate() - moment(completeData.data_pembangunan.tanggal_mulai, "DD/MM/YYYY").toDate())/(1000*3600*24)}  Hari</div>
													</div>
													<div class="flex flex-direction-col w-50">
														<div class="caption-card-detail">Selesai Pembangunan</div>
														<div class="content-card-detail">{completeData.data_pembangunan.tanggal_selesai}</div>
													</div>
												</div>
												<div class="flex w-100">
													<div class="flex flex-direction-col w-100">
														<div class="caption-card-detail">Keterangan</div>
														<div class="caption-card-detail">{completeData.data_pembangunan.keterangan}</div>
													</div>
												</div>
											</div>
										</div>
						...
						{/if}
						{#if completeData.data_kavling == null}
							<div class="card w-50 flex flex-gap-semi-large flex-direction-col">
								<div class="w-100 flex flex-direction-col flex-gap-large">
									<div class="flex flex-gap-regular">
										<div class="w-100 flex flex-direction-col flex-gap-regular">
										...
										<div class="w-100 flex flex-direction-col flex-gap-regular">
											<div class="w-100 flex flex-direction-col flex-gap-semi-small">
												...
												<div class="flex w-100">
													<div class="flex flex-direction-col w-50">
														<div class="caption-card-detail">Mulai Pembangunan</div>
														<div class="content-card-detail">{completeData.data_kavling.tanggal_mulai}</div>
													</div>
													<div class="flex flex-direction-col w-50">
														<div class="caption-card-detail">Target Selesai</div>
														<div class="content-card-detail">{completeData.data_kavling.tanggal_target}</div>
													</div>
												</div>
												<div class="flex w-100">
													<div class="flex flex-direction-col w-50">
														<div class="caption-card-detail">Sisa Waktu</div>
														<div class="content-card-detail">{(moment(completeData.data_kavling.tanggal_target, "DD/MM/YYYY").toDate() - moment(completeData.data_kavling.tanggal_mulai, "DD/MM/YYYY").toDate())/(1000*3600*24)}  Hari</div>
													</div>
													<div class="flex flex-direction-col w-50">
														<div class="caption-card-detail">Selesai Pembangunan</div>
														<div class="content-card-detail">{completeData.data_kavling.tanggal_selesai}</div>
													</div>
												</div>
												<div class="flex w-100">
													<div class="flex flex-direction-col w-100">
														<div class="caption-card-detail">Keterangan</div>
														<div class="caption-card-detail">{completeData.data_kavling.keterangan}</div>
													</div>
												</div>
											</div>
										</div>
												...
												<div class="item-progress flex flex-direction-col">
														...
														<div class="flex w-100 flex-center-vertical">
															<div class="w-100">
																<div class="accent-title-progress">
																	Fasilitas Umum - <span class="accent-title-reject">0%</span>
																</div>
															</div>
														</div>
														<div class="flex w-100 flex-center-vertical">
													...
													<div class="flex flex-direction-col border-item-legal">
														<div class="flex w-100 flex-center-vertical">
															<div class="w-100">
																<div class="accent-title-progress">
																	Infrastruktur - <span class="accent-title-reject">0%</span>
																</div>
															</div>
														</div>
														<div class="flex w-100 flex-center-vertical">
															<div class="w-20">
																<div class="name-progress">Jalan Cor/Makadam</div>
															</div>
															<div class="title-progress flex flex-center-horizontal w-10"></div>
															<div class="title-progress flex flex-center-horizontal w-10"></div>
															<div class="title-progress flex flex-center-horizontal w-10"></div>
													...
													<div class="flex flex-direction-col border-item-legal">
														<div class="flex w-100 flex-center-vertical">
															<div class="w-100">
																<div class="accent-title-progress">
																	SLF - <span class="accent-title-reject">0%</span>
																</div>
															</div>
														</div>
														<div class="flex w-100 flex-center-vertical">
													...
													<div class="flex w-100 flex-center-vertical">
														...
														<div class="flex flex-direction-col border-item-legal">
																...
																<div class="w-100">
																	<div class="accent-title-progress">
																		{#if progressUnit[0].detail_progress_bar == 100}
																			Fasilitas Umum - <span class="accent-title-success">{Number(progressUnit[0].detail_progress_bar.toFixed(1))}%</span>
																		{:else}
																		Fasilitas Umum - <span class="accent-title-reject">{Number(progressUnit[0].detail_progress_bar.toFixed(1))}%</span>
																		{/if}
																	</div>
																</div>
															</div>
															...
															<div class="flex w-100 flex-center-vertical">
																...
																<div class="title-progress flex flex-center-horizontal w-10">{progressUnit[0].detail[1].tanggal_mulai}</div>
																<div class="title-progress flex flex-center-horizontal w-10">{progressUnit[0].detail[1].tanggal_target}</div>
																<div class="title-progress flex flex-center-horizontal w-10">{(moment(progressUnit[0].detail[1].tanggal_target, "DD/MM/YYYY").toDate() - moment(progressUnit[0].detail[1].tanggal_mulai, "DD/MM/YYYY").toDate())/(1000*3600*24)}  Hari</div>
																<div class="title-progress flex flex-center-horizontal w-10">{progressUnit[0].detail[1].tanggal_selesai}</div>
																<div class="title-progress flex flex-center-horizontal w-10">
																	{#if progressUnit[0].detail[1].progress == true}
																		<div class="text-drop-card padding-spec-nup-1"><input type="checkbox" name="" checked></div>
																	{:else}
																		<div class="text-drop-card padding-spec-nup-1"><input type="checkbox" name=""></div>
																	{/if}
																</div>
																<div class="title-progress w-30">{progressUnit[0].detail[1].keterangan}
																</div>
															</div>
															</a>
															...
															<div class="flex w-100 flex-center-vertical">
																...
																<div class="title-progress flex flex-center-horizontal w-10">{progressUnit[0].detail[2].tanggal_mulai}</div>
																<div class="title-progress flex flex-center-horizontal w-10">{progressUnit[0].detail[2].tanggal_target}</div>
																<div class="title-progress flex flex-center-horizontal w-10">{(moment(progressUnit[0].detail[2].tanggal_target, "DD/MM/YYYY").toDate() - moment(progressUnit[0].detail[2].tanggal_mulai, "DD/MM/YYYY").toDate())/(1000*3600*24)}  Hari</div>
																<div class="title-progress flex flex-center-horizontal w-10">{progressUnit[0].detail[2].tanggal_selesai}</div>
																<div class="title-progress flex flex-center-horizontal w-10">
																	{#if progressUnit[0].detail[2].progress == true}
																		<div class="text-drop-card padding-spec-nup-1"><input type="checkbox" name="" checked></div>
																	{:else}
																		<div class="text-drop-card padding-spec-nup-1"><input type="checkbox" name=""></div>
																	{/if}
																</div>
																<div class="title-progress w-30">{progressUnit[0].detail[2].keterangan}
																</div>
															</div>
															</a>
															...
															<div class="flex w-100 flex-center-vertical">
																...
																<div class="title-progress flex flex-center-horizontal w-10">{progressUnit[0].detail[3].tanggal_mulai}</div>
																<div class="title-progress flex flex-center-horizontal w-10">{progressUnit[0].detail[3].tanggal_target}</div>
																<div class="title-progress flex flex-center-horizontal w-10">{(moment(progressUnit[0].detail[3].tanggal_target, "DD/MM/YYYY").toDate() - moment(progressUnit[0].detail[3].tanggal_mulai, "DD/MM/YYYY").toDate())/(1000*3600*24)}  Hari</div>
																<div class="title-progress flex flex-center-horizontal w-10">{progressUnit[0].detail[3].tanggal_selesai}</div>
																<div class="title-progress flex flex-center-horizontal w-10">
																	{#if progressUnit[0].detail[3].progress == true}
																		<div class="text-drop-card padding-spec-nup-1"><input type="checkbox" name="" checked></div>
																	{:else}
																		<div class="text-drop-card padding-spec-nup-1"><input type="checkbox" name=""></div>
																	{/if}
																</div>
																<div class="title-progress w-30">{progressUnit[0].detail[3].keterangan}
																</div>
															</div>
															</a>
														</div>
																...
																<div class="w-100">
																	<div class="accent-title-progress">
																		{#if progressUnit[1].detail_progress_bar == 100}
																			Infrastruktur - <span class="accent-title-success">{Number(progressUnit[1].detail_progress_bar.toFixed(1))}%</span>
																		{:else}
																		Infrastruktur - <span class="accent-title-reject">{Number(progressUnit[1].detail_progress_bar.toFixed(1))}%</span>
																		{/if}
																	</div>
																</div>
															</div>
														...
														<div class="flex flex-direction-col border-item-legal">
																...
																<div class="w-100">
																	<div class="accent-title-progress">
																		{#if progressUnit[2].detail_progress_bar == 100}
																			SLF - <span class="accent-title-success">{Number(progressUnit[2].detail_progress_bar.toFixed(1))}%</span>
																		{:else}
																		SLF - <span class="accent-title-reject">{Number(progressUnit[2].detail_progress_bar.toFixed(1))}%</span>
																		{/if}
																	</div>
																</div>
															</div>
															...
															<div class="flex w-100 flex-center-vertical">
																...
																<div class="title-progress flex flex-center-horizontal w-10">{(moment(progressUnit[2].detail[1].tanggal_target, "DD/MM/YYYY").toDate() - moment(progressUnit[1].detail[1].tanggal_mulai, "DD/MM/YYYY").toDate())/(1000*3600*24)}  Hari</div>
