			...
			<div class="flex flex-direction-col flex-gap-large" in:fly={{ y: -20, duration: 600 }}>
				<div class="flex flex-between-horizontal flex-center-vertical w-100">
					...
					<div class="flex flex-gap-regular">
						<a href="/v1/super-admin/nup/edit-nup" class="no-decor"><button class="btn-fill-warning flex flex-center-vertical flex-gap-small"><img src="/images/icons/Edit_White.svg"> <span>Edit</span></button></a>
						<a href="/v1/super-admin/nup/detail-nup" class="no-decor"><button class="btn-fill-danger flex flex-center-vertical flex-gap-small"><img src="/images/icons/Trash_White.svg"> <span>Hapus</span></button></a>
					</div>
				</div>
				...
				<div class="flex flex-direction-col flex-gap-regular" in:fly={{ y: -20, duration: 600 }}>
					<div class="flex">
						...
						<div class="w-40 flex flex-end-horizontal">
							<a href="/v1/super-admin/kelola-perum/detail-perumahan/{idPerumahan}/tambah-unit" class="no-decor"><button class="btn-fill flex flex-center-vertical flex-gap-small"><img src="/images/icons/Add_Plus.svg"> <span>Tambah Unit</span></button></a>
						</div>
					</div>
					<div class="scroll-x flex flex-direction-col flex-gap-regular">
						...
						<div class="card-head w-content-7 height-fit">
							<div class="flex">
								...
								<div class="flex flex-gap-small flex-center-vertical w-15 border-non-separate">
										<a href="/v1/super-admin/kelola-perum/detail-perumahan/edit-unit" class="no-decor"><img src="/images/icons/Edit.svg"></a>
				...
				<div class="w-60">
					<div class="flex flex-direction-col flex-gap-regular" in:fly={{ y: -20, duration: 600 }}>
						<div class="flex">
							...
							<div class="w-40 flex flex-end-horizontal">
								<a href="/v1/super-admin/kelola-perum/detail-perumahan/{idPerumahan}/tambah-blok" class="no-decor"><button class="btn-fill flex flex-center-vertical flex-gap-small"><img src="/images/icons/Add_Plus.svg"> <span>Tambah Blok</span></button></a>
							</div>
						</div>
						<div class="scroll-x flex flex-direction-col flex-gap-regular">
