			...
			<div class="flex flex-direction-col flex-gap-large" in:fly={{ y: -20, duration: 600 }}>
				<div class="flex flex-between-horizontal flex-center-vertical w-100">
					...
					<div class="flex flex-gap-regular">
						...
						<a href="/v1/super-admin/kompilasi-perumahan/tambah-kompilasi-perumahan" class="no-decor"><button class="btn-fill flex flex-center-vertical flex-gap-small"><img src="/images/icons/Add_Plus.svg"> <span>Tambah Unit</span></button></a>
					</div>
				</div>
				<div class="flex flex-direction-col flex-gap-regular">
					...
					<div class="scroll-x flex flex-direction-col flex-gap-regular">
						...
						<a href="/v1/super-admin/kompilasi-perumahan/detail-kompilasi-perumahan/1" class="no-decor">
							<div class="card-head w-content-2 height-fit">
								<div class="flex">
									...
									<div class="flex flex-gap-small flex-center-vertical w-10 no-border-table">
										<a href="/v1/super-admin/nup/edit-nup" class="no-decor"><img src="/images/icons/Edit.svg"></a>
