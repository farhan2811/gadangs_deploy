			...
			<div class="flex flex-direction-col flex-gap-semi-large" in:fly={{ y: -20, duration: 600 }}>
				<div class="flex flex-between-horizontal flex-center-vertical w-100">
					...
					<div class="flex flex-gap-regular">
						<a href="/v1/super-admin/cicilan/atur-cicilan/{data.params.id_nup}" class="no-decor"><button class="btn-fill flex flex-center-vertical flex-gap-small" style="white-space: nowrap;">Atur Cicilan</button></a>
					</div>
				</div>
								...
								<div class="flex flex-gap-regular">
									<div class="w-100 flex flex-direction-col flex-gap-regular">
										<div class="flex flex-center-vertical flex-between-horizontal">
											...
											<a href="/v1/super-admin/cicilan/selisih-plafond/{data.params.id_nup}" class="no-decor">
								...
								<div class="flex flex-gap-regular">
									<div class="w-100 flex flex-direction-col flex-gap-regular">
										<div class="flex flex-center-vertical flex-between-horizontal">
											...
											<a href="/v1/super-admin/cicilan/biaya-proses/{data.params.id_nup}" class="no-decor">
												<button class="btn-outline flex flex-center-vertical flex-gap-small">
													<span>Atur</span>
												</button>
											</a>
								...
								<div class="flex flex-gap-regular">
									<div class="w-100 flex flex-direction-col flex-gap-regular">
										<div class="flex flex-center-vertical flex-between-horizontal">
											...
											<a href="/v1/super-admin/cicilan/sbum/{data.params.id_nup}" class="no-decor">
												<button class="btn-outline flex flex-center-vertical flex-gap-small">
													<span>Atur</span>
												</button>
											</a>
