...
<div id="after-login-layout">
	<Navbar/>
	<div class="flex">
		<Sidebar statusPointer="Kompilasi" pagePointer="finance"/>
							...
							<div class="flex flex-direction-col flex-gap-semi-small">
								...
								<div class="flex flex-gap-regular">
									<div class="flex flex-direction-col flex-gap-small w-50">
										...
										<input type="text" name="" class="input-nup" placeholder="nama notaris...">
									</div>
									<div class="flex flex-direction-col flex-gap-small w-50">
										<div class="title-input-nup">Nominal Pembayaran Notaris</div>
										<input type="text" name="" class="input-nup" placeholder="nominal pembayaran notaris..">
									</div>
								</div>
								<div class="flex flex-gap-regular">
									<div class="flex flex-direction-col flex-gap-small w-50">
										<div class="title-input-nup">Tanggal Pembayaran</div>
										<input type="text" name="" class="input-nup" placeholder="tanggal pembayaran..">
									</div>
									<div class="flex flex-direction-col flex-gap-small w-50">
										<div class="title-input-nup">Pencairan Plafond KPR</div>
										<input type="text" name="" class="input-nup" placeholder="pencairan plafond kpr..">
									</div>
								</div>
								...
								<div class="card-secondary flex flex-direction-col flex-gap-semi-large">
									<div class="flex flex-gap-regular">
										...
										<div class="flex flex-direction-col flex-gap-small w-50">
											...
											<input type="text" name="" class="input-nup" placeholder="nominal pencairan..">
										</div>
									</div>
								</div>
