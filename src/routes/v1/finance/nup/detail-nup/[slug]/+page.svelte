...
<div id="after-login-layout">
		...
		<div class="modal-backdrop">
			<div class="flex flex-center-vertical flex-center-horizontal h-100">
				<div class="card-2 flex flex-direction-col flex-gap-regular w-30" in:fly={{ y: -20, duration: 600 }} out:fly={{ y: -20, duration: 600 }}>
					<div class="title-modal">Data NUP Sudah Sesuai?</div>
					<div class="desc-modal">Mohon validasi data pada Form NUP dan pastikan data tersebut lengkap dan sesuai dengan Syarat & Ketentuan yang berlaku. </div>
					<div class="flex flex-gap-regular">
						<button class="btn-fill-info flex flex-center-vertical flex-gap-small flex-center-horizontal w-33" on:click={() => {
							approvalModal = 0;
						...
						<button class="btn-fill-primary flex flex-center-vertical flex-gap-small flex-center-horizontal w-33" on:click={() => {
							ApiController({
								method: "POST",
								endpoint: `nup/${idNup}/approval/finance`
							}).then(response => {
	...
	<Navbar/>
	<div class="flex">
		<Sidebar statusPointer="Nup" pagePointer="finance"/>
